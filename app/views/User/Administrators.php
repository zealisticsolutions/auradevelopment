					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						...
						?>
							<tr>
								...
								<td>
									<a href="?controller=User&action=Profile&id=<?php echo $patient['id']; ?>"><?php if(!empty($patient['firstname'])) {echo  $patient['firstname']." ".$patient['lastname'];} else {echo "NA";} ?></a>
								</td>
								
								<td><?php  if(!empty($patient['firstname'])) { echo  $patient['email'];} else {echo "NA";}?></td>
								<td class="hidden-480">
									<?php 
