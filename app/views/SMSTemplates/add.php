				...
				<div class="col-xs-12">
					<div class="row">
						...
						<form class="form-horizontal" method="post">
							...
							<div class="form-group">
								<div class="col-sm-3">
									<select class="form-control aura_multiple_select" name="template_type" id="form-field-select-2">
										<option value="">SMS Template Name</option>
										<?php 
										...
										?>
										<option value="<?php echo $emailTempType['stt_id']; ?>" <?php if(!empty($_POST['template_type'])){echo "selected";} ?>><?php echo $emailTempType['stt_name'] ?></option>
							...
							<div class="form-group">
								<div class="col-sm-8">
									<textarea rows="4" cols="31"  name ="content" id ="description"><?php if(!empty($_POST['content'])){echo $_POST['content'];} ?></textarea>
									<?php if(!empty($tpl['errorMsg']['content'])) {?>
										<br><label class="errMsg"><?php echo $tpl['errorMsg']['content']; ?></label>
									<?php } ?>
								</div>
								<div class="col-sm-4">
