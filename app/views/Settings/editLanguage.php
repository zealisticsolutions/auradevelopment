				...
				<div class="col-xs-12">
					<div class="row">
						...
						<form class="form-inline" method="post">
							<input type="text" class="" value="<?php echo $tpl['result'][0]['language_name']; ?>" name="Language" placeholder="Language" required />
							<input type="hidden" class="" value="1" name="Update" />
							<input type="hidden" class="" value="<?php echo $tpl['result'][0]['language_id']; ?>" name="language_id" />
