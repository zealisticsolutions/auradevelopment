				...
				<div class="col-xs-12">
					<div class="row">
						...
						<form class="form-inline" method="post">
							<input type="text" id="form-field-1" placeholder="SMS Template Name"  name="stt_name" value=""/>
							<button style = "margin-bottom: 4px;"type="submit" class="btn btn-info btn-sm">
								<i class="ace-icon fa fa-plus bigger-110"></i>Add
							</button>
							<?php if(!empty($tpl['errorMsg']['stt_name'])) {?>
								<br><label class="errMsg"><?php echo $tpl['errorMsg']['stt_name']; ?></label>
							<?php } ?>
						...
						<table id="simple-table" class="table  table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										<td>
											<a href="?controller=Settings&action=editSmsTemplateTyep&id=<?php echo $language['stt_id']; ?>">
												<?php echo $language['stt_name'] ?>
											</a>
										</td>
