				...
				<div class="col-xs-12">
					<div class="row">
						...
						<form class="form-inline" method="post">
							<input type="text" class="" value="" name="language" placeholder="Language" required />
									...
									<tr>
										...
										<td>
											<div class="hidden-sm hidden-xs btn-group">
												<a href="?controller=Settings&action=editLanguage&id=<?php echo $language['language_id']; ?>" class="btn btn-xs btn-info">
