				...
				<div class="col-xs-12">
					<div class="row">
						...
						<form class="form-inline" method="post">
							<input type="text" class="" value="" name="medical_history" placeholder="Medical History" required />
									...
									<tr>
										...
										<td>
											<div class="hidden-sm hidden-xs btn-group">
												<a href="?controller=Settings&action=editMedicalHistory&id=<?php echo $medicalHistory['mh_id']; ?>" class="btn btn-xs btn-info">
