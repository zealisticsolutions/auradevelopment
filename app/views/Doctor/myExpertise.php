	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">My Specialties</li>
			</ul><!-- /.breadcrumb -->
		...
		<div class="page-content">
			...
			<?php if(!empty($_SESSION['specialitiesError'])) {?>
				<label class="errMsg"><?php echo $_SESSION['specialitiesError'];?></label>
			<?php } $_SESSION['specialitiesError']="";?>
			<div class="row">
				<div class="col-xs-12">
					<div class="col-xs-6">
						<!-- PAGE CONTENT ENDS -->
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
							<?php 
								$medicalHistories = $tpl['result']['master'];
					...
					<div class="col-xs-6">
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<?php 
								...
								$patients = $tpl['result']['mySpecialities'];
